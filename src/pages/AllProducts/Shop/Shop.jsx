        ...
        <div className='flex flex-row gap-3 my-5'>
            <div className='w-3/12'>
                <div className='w-full'>
                    <h3 className='bg-gray-500 p-5 w-full text-xl font-black'>Browse Categories</h3>
                ...
                <div className='w-full'>
                    <h3 className='bg-gray-500 p-5 w-full text-xl font-black'>Product Filters</h3>
                    <div className='my-2'>
                        <h4 className='my-1 text-xl text-left font-black'>Brands</h4>
                    ...
                    <div className='my-2'>
                        <h4 className='my-1 text-xl text-left font-black'>Colors</h4>
                    ...
                    <div className='my-2'>
                        <h4 className='my-1 text-xl text-left font-black'>Price</h4>
