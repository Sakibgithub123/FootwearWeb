        ...
        <div className="category">
            ...
            <div className="flex justify-center">
                <div className="w-full max-w-md rounded-lg bg-white px-4 md:px-10 pb-10 pt-8 shadow-md dark:bg-zinc-900">
                    <div className="mb-6">
                        <h2 className="text-center text-sm md:text-2xl pb-2 font-semibold text-orange-300 tracking-tight">Category Add Form</h2>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-6">
                        ...
                        <div className="space-y-2 text-[10px] md:text-sm text-zinc-700 dark:text-zinc-400">
                            ...
                            <select
                                ...
                                className="h-10 w-full rounded border px-3 py-2 text-[10px] md:text-smleading-tight focus:outline-none focus:ring-1 dark:border-zinc-700"
                            >
                ...
                <table className="min-w-[90%] shadow-md  border mx-auto border-gray-100  my-6">
                    <thead>
                        <tr className="bg-orange-400 text-white">
                            ...
                            <th className="md:py-2 md:px-3 text-[10px] md:text-sm border-b">CATEGORY NAME</th>
                            <th className="md:py-2 md:px-3 text-[10px] md:text-sm border-b">STATUS</th>
                            <th className="md:py-2 md:px-3 text-[10px] md:text-sm md:text-end">ACTION</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
                            category.map((categories, index) =>
                                <tr key={index} className="hover:bg-gray-50 transition duration-300">
                                    ...
                                    <td className="py-2 px-3  border-b text-[10px] md:text-xs font-bold">{categories.category}</td>
